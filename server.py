...
lessons = [
    ...
    },
    {
        ...
        "text": "You might recognize the chord progression from Olivia Rodrigo's song 'Traitor'. (You may have to click 'Watch on Youtube' due to copyright reasons)",
        "video":"https://www.youtube.com/embed/E2NuSNZNKnM",
        "alt":"Traitor by Olivia Rodrigo",
    },
    {
        "id": 5,
    ...
    },
    {
        ...
        "text": "You might recognize the chord progression from Olivia Rodrigo's song 'Vampire'. It works well with the song because the unexpected sounds add an eerie quality! (You may have to click 'Watch on Youtube' due to copyright reasons)",
        "video": "https://www.youtube.com/embed/aHmg0jsmNhg",
        "alt":"Vampire by Olivia Rodrigo"
    },
]
...
questions = [
    ...
    {
        "id": 5,
        "text": """Match each song to its chord progression (left: Traitor, right: Vampire):""",
        "options": {1:"https://upload.wikimedia.org/wikipedia/en/b/b2/Olivia_Rodrigo_-_SOUR.png",
                    2: "https://i.discogs.com/Rd83pLBgs7speREI6__eXegcuCbhIm1qh3ZXuAmb5yI/rs:fit/g:sm/q:90/h:598/w:600/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI3NTUy/NjkwLTE2ODg0MzY5/NzItNzY1NC5qcGVn.jpeg",},
        "answer": ""
    },
]
